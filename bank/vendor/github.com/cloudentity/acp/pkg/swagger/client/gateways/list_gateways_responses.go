...
/*ListGatewaysOK handles this case with default header values.
...
/*ListGatewaysUnauthorized handles this case with default header values.
...
/*ListGatewaysForbidden handles this case with default header values.
