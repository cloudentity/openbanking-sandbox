...
func (m *OBActiveOrHistoricCurrencyAndAmount5) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OBActiveOrHistoricCurrencyAndAmount5) validateAmount(formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount5) validateCurrency(formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount5) UnmarshalBinary(b []byte) error {
	var res OBActiveOrHistoricCurrencyAndAmount5
