...
func (m *OBOtherCodeType13) validateCode(formats strfmt.Registry) error {
...
func (m *OBOtherCodeType13) validateDescription(formats strfmt.Registry) error {
...
func (m *OBOtherCodeType13) validateName(formats strfmt.Registry) error {
