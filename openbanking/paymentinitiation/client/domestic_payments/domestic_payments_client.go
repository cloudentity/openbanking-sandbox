...
type ClientService interface {
	CreateDomesticPaymentConsents(params *CreateDomesticPaymentConsentsParams, authInfo runtime.ClientAuthInfoWriter) (*CreateDomesticPaymentConsentsCreated, error)

	CreateDomesticPayments(params *CreateDomesticPaymentsParams, authInfo runtime.ClientAuthInfoWriter) (*CreateDomesticPaymentsCreated, error)

	GetDomesticPaymentConsentsConsentID(params *GetDomesticPaymentConsentsConsentIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetDomesticPaymentConsentsConsentIDOK, error)

	GetDomesticPaymentConsentsConsentIDFundsConfirmation(params *GetDomesticPaymentConsentsConsentIDFundsConfirmationParams, authInfo runtime.ClientAuthInfoWriter) (*GetDomesticPaymentConsentsConsentIDFundsConfirmationOK, error)

	GetDomesticPaymentsDomesticPaymentID(params *GetDomesticPaymentsDomesticPaymentIDParams, authInfo runtime.ClientAuthInfoWriter) (*GetDomesticPaymentsDomesticPaymentIDOK, error)
