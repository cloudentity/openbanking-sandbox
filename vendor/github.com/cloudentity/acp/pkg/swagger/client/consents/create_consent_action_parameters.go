...
// WithTid adds the tid to the create consent action params
func (o *CreateConsentActionParams) WithTid(tid string) *CreateConsentActionParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create consent action params
func (o *CreateConsentActionParams) SetTid(tid string) {
	o.Tid = tid
}
