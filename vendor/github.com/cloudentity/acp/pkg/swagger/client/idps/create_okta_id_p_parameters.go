...
// WithTid adds the tid to the create okta ID p params
func (o *CreateOktaIDPParams) WithTid(tid string) *CreateOktaIDPParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create okta ID p params
func (o *CreateOktaIDPParams) SetTid(tid string) {
	o.Tid = tid
}
