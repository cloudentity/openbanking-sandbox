...
// WithTid adds the tid to the update service params
func (o *UpdateServiceParams) WithTid(tid string) *UpdateServiceParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the update service params
func (o *UpdateServiceParams) SetTid(tid string) {
	o.Tid = tid
}
