...
// NewGetAccountsAccountIDBeneficiariesParams creates a new GetAccountsAccountIDBeneficiariesParams object
// with the default values initialized.
func NewGetAccountsAccountIDBeneficiariesParams() *GetAccountsAccountIDBeneficiariesParams {
	var ()
	return &GetAccountsAccountIDBeneficiariesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAccountsAccountIDBeneficiariesParamsWithTimeout creates a new GetAccountsAccountIDBeneficiariesParams object
...
// NewGetAccountsAccountIDBeneficiariesParamsWithContext creates a new GetAccountsAccountIDBeneficiariesParams object
...
// NewGetAccountsAccountIDBeneficiariesParamsWithHTTPClient creates a new GetAccountsAccountIDBeneficiariesParams object
...
for the get accounts account Id beneficiaries operation typically these are written to a http.Request
*/
...
func (o *GetAccountsAccountIDBeneficiariesParams) WithTimeout(timeout time.Duration) *GetAccountsAccountIDBeneficiariesParams {
...
func (o *GetAccountsAccountIDBeneficiariesParams) WithContext(ctx context.Context) *GetAccountsAccountIDBeneficiariesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get accounts account Id beneficiaries params
func (o *GetAccountsAccountIDBeneficiariesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get accounts account Id beneficiaries params
func (o *GetAccountsAccountIDBeneficiariesParams) WithHTTPClient(client *http.Client) *GetAccountsAccountIDBeneficiariesParams {
...
func (o *GetAccountsAccountIDBeneficiariesParams) WithAccountID(accountID string) *GetAccountsAccountIDBeneficiariesParams {
...
func (o *GetAccountsAccountIDBeneficiariesParams) WithAuthorization(authorization string) *GetAccountsAccountIDBeneficiariesParams {
...
func (o *GetAccountsAccountIDBeneficiariesParams) WithXFapiAuthDate(xFapiAuthDate *string) *GetAccountsAccountIDBeneficiariesParams {
...
func (o *GetAccountsAccountIDBeneficiariesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
