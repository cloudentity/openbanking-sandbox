...
func (m *OBTransactionCardInstrument1) validateAuthorisationTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, oBTransactionCardInstrument1TypeAuthorisationTypePropEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *OBTransactionCardInstrument1) validateCardSchemeNameEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, oBTransactionCardInstrument1TypeCardSchemeNamePropEnum); err != nil {
		return err
	}
	return nil
}
