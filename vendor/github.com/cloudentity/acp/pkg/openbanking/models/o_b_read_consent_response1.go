...
func (m *OBReadConsentResponse1Data) validatePermissionsItemsEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, oBReadConsentResponse1DataPermissionsItemsEnum); err != nil {
		return err
	}
	return nil
}
...
func (m *OBReadConsentResponse1Data) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, oBReadConsentResponse1DataTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}
