...
func (m *OBOtherCodeType12) validateCode(formats strfmt.Registry) error {
...
func (m *OBOtherCodeType12) validateDescription(formats strfmt.Registry) error {
...
func (m *OBOtherCodeType12) validateName(formats strfmt.Registry) error {
