...
export default function ClientCard({client, onRevokeClient, onRevokeConsent}) {
            ...
            >
                <div>
                    <Avatar variant={"square"} style={{
                        ...
                        width: 44,
                        height: 44
                    }}>{client?.client_name[0]?.toUpperCase()}</Avatar>
                </div>
                <div style={{width: "100%"}}>
                    <div style={{display: "flex", alignItems: "center"}}>
                        <div style={{marginLeft: 24}}>
                            <Typography style={{color: '#C2C3C6', textTransform: 'uppercase', fontSize: 12}}>Client
                                Name</Typography>
                            <Typography
                                style={{fontSize: 16, marginTop: 4}}><strong>{client.client_name}</strong></Typography>
                        </div>
                    </div>
